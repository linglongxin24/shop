<template>
  <div class="shop_container">
    <ul  v-if="shopList.length" class="shop_list" >
      <li class="shop_li border-1px" v-for="(shop,index) in shopList" :key="index">
        <a>
          <div class="shop_left">
            <img class="shop_img" :src="BASE_IMG_URL+shop.image_path">
          </div>
...
<!--      </li>-->
    ...
    <ul v-else >
      <li v-for="item in 6" :key="item">
        <img  src="./images/shop_back.svg" alt="background">
      </li>
    </ul>
  </div>
</template>
...
export default {
  ...
  data () {
    return {
      BASE_IMG_URL: 'http://cangdu.org:8001/img/'
    }
  },
  computed: {
    ...mapState(['shopList'])
